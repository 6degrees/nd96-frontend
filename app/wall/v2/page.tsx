    ...
    useEffect(() => {
        ...
        const boot = async (): Promise<void> => {
            try {
                ...
                screenUnsubscribe = transport.subscribe('screen.message_moment', {
                ...
                {pop && presenting && !holding && (
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                className="mt-8 flex items-end justify-between gap-6 border-t border-snd-night/10 pt-6">
                                ...
                                {pop.signature?.svg && (
                                    <SignatureMark svg={pop.signature.svg}
        ...
        >
            ...
            >
                ...
                {rendered.signature?.svg && (
                    <SignatureMark svg={rendered.signature.svg} className="h-6 w-16 shrink-0 text-sand/60"/>
                )}
            </div>
        </div>
    );
