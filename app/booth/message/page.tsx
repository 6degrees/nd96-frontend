...
|--------------------------------------------------------------------------
|
| All form steps are displayed on a single screen to minimize
| user interaction during the event.
|
*/
...
export default function BoothPage() {
    ...
    */
    ...
    const [pieceNo, setPieceNo] = useState<number | null>(null);
    ...
    */
    ...
    const charProgress = Math.min(
        100,
        (body.length / limits.bodyMax) * 100
    );
    ...
    */
    ...
    const submit = async () => {
        ...
        try {
            ...
            // Best-effort lookup for the mosaic piece number.
            api.getStats()
                .then((s) => setPieceNo(s.messages))
                .catch(() => setPieceNo(null));
        } catch (e) {
            setStatus('error');
                ...
                >
                    ...
                    >
                        <div className="flex flex-col items-center px-6 py-10 text-center sm:px-10 sm:py-12">
                            ...
                            <h1 className="font-display text-4xl leading-tight text-snd-night sm:text-5xl">
                                {t('booth.sentTitle')}
                            </h1>

                            <p className="user-text mt-4 max-w-sm text-xl leading-relaxed text-snd-night/75">
                                {t('booth.sent')}
                            </p>

                            <p className="mt-3 max-w-sm text-base text-snd-night/55">
                                {t('booth.sentHint')}
                            </p>

                            {pieceNo !== null && (
                                <p className="mt-3 max-w-sm text-lg font-semibold text-saudi">
                                    {t('booth.sentPiece').replace(
                                        '{n}',
                                        String(pieceNo)
                                    )}
                                </p>
                            ...
                            <footer className="mt-10 w-full border-t border-snd-night/10 pt-8">
                                <CoBrand
                                    tone="light"
                                    className="justify-center text-snd-night/70"
                                />
                            </footer>
                        </div>
                    </div>
    ...
    return (
        <main className="snd-grid relative flex min-h-[100dvh] items-center justify-center bg-night px-4 py-6 sm:px-6">
            <SndPatternFrame
                ...
                <div className="relative z-10 mx-auto flex w-full flex-col rounded-2xl bg-sand text-snd-night shadow-[0_0_80px_rgba(0,0,0,0.35)]"
                    style={{
                        paddingTop: 'max(0px, env(safe-area-inset-top))',
                        paddingBottom: 'max(0px, env(safe-area-inset-bottom))',
                    }}>
                    <div className="flex flex-1 flex-col gap-6 px-6 py-6 sm:px-8 sm:py-8">
                        ...
                        */}
                        ...
                        <header className="flex items-start justify-between gap-4 border-b border-snd-night/10 pb-6">
                            <div className="min-w-0 flex-1">
                                ...
                                <p className="mt-2 text-lg text-snd-night/65">
                                    {t('booth.subtitle')}
                                </p>
                            ...
                            <LangToggle
                                tone="light"
                                className="min-h-[52px] shrink-0 px-5 text-base"
                            />
                        </header>
                        ...
                        */}
                        ...
                        <p className="text-sm leading-relaxed text-snd-night/55">
                            {t('booth.consent')}
                        </p>
                        ...
                        */}
                        ...
                        <div>
                            ...
                            <SignatureField
                                ref={signature}
                                onStrokeEnd={clearError}
                            />

                            <p className="mt-2 text-sm text-snd-night/45">
                                {t('booth.signHint')}
                            </p>
                        </div>
